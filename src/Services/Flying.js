          ...
          <div className="lg:w-2/3 lg:pr-8">
            <header className="mb-6">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold mb-4 sm:mb-0 text-green-800">
                Flying Insects Control Services
              </h1>
              <div class="w-1/6 border-b-4 mt-6 mb-5 border-orange-700"></div>
              <p className="text-gray-700 mt-4">
               we understand how flying insects like mosquitoes, flies, moths, and wasps can create 
               serious health hazards, disturb daily life, and affect business operations. 
               Our specialized Flying Insects Pest Control Services are designed to protect your home, office, and commercial spaces from these fast-breeding pests.
              </p>
              <p className="text-gray-700 mt-2">
                We use eco-friendly and safe treatment methods to target both adult insects and breeding sources, ensuring long-term relief.
              </p>
            </header>

            <section className="mb-6">
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold mb-4 sm:mb-0 text-black">
                Why Flying Insects Control?
              </h2>
              <ul className="ml-6 mt-3 text-gray-700 space-y-1">
                <li className="relative pl-5 before:content-['>'] before:absolute before:left-0 before:text-orange-600 before:font-bold">Prevents diseases like malaria, dengue, and food poisoning.</li>
                <li className="relative pl-5 before:content-['>'] before:absolute before:left-0 before:text-orange-600 before:font-bold">Keeps kitchens, food areas, and living spaces clean.</li>
                <li className="relative pl-5 before:content-['>'] before:absolute before:left-0 before:text-orange-600 before:font-bold">No more buzzing, bites, or stings disturbing daily life.</li>
                <li className="relative pl-5 before:content-['>'] before:absolute before:left-0 before:text-orange-600 before:font-bold">Protects clothes, fabrics, and stored goods from moths.</li>
              </ul>
            </section>
            ...
            <section className="mb-6">
              ...
              <ul className=" ml-6 mt-3 text-gray-700 space-y-1">
                <li className="relative pl-5 before:content-['>'] before:absolute before:left-0 before:text-orange-600 before:font-bold">Mosquito Control</li>
                <li className="relative pl-5 before:content-['>'] before:absolute before:left-0 before:text-orange-600 before:font-bold">House Fly Control</li>
                          <li className="relative pl-5 before:content-['>'] before:absolute before:left-0 before:text-orange-600 before:font-bold">Fruit Fly Control</li>
                                    <li className="relative pl-5 before:content-['>'] before:absolute before:left-0 before:text-orange-600 before:font-bold">Moth Control</li>
              </ul>
            </section>
            ...
            <section className="mb-6">
              ...
              <table className="w-full border mt-4 text-sm text-left">
                ...
                <tbody>
                  <tr>
                    <td className="px-4 py-2 border">Mosquito Control</td>
                    <td className="px-4 py-2 border">
                      Targeted treatment to reduce mosquito breeding and protect against diseases like dengue and malaria.
                    </td>
                  </tr>
                   <tr>
                    <td className="px-4 py-2 border">House Fly Control</td>
                    <td className="px-4 py-2 border">
                     Safe solutions to prevent food contamination and maintain hygiene.
                    </td>
                  </tr>
                  
                  <tr>
                    <td className="px-4 py-2 border">Fruit Fly Control</td>
                    <td className="px-4 py-2 border">
                  Effective treatment for kitchens, restaurants, and food storage areas.
                    </td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border">Moth Control</td>
                    <td className="px-4 py-2 border">
                    Protection against fabric and stored product damage.
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <section className="mb-6">
              ...
              <ol className="ml-6 mt-3 text-gray-700 space-y-1">
                ...
                <li className="relative pl-5 before:content-['>'] before:absolute before:left-0 before:text-orange-600 before:font-bold">Peaceful, insects-free surroundings</li>
              </ol>
            </section>
   ...
   <div className="bg-gradient-to-r from-green-700 via-green-900 to-green-900 py-4 sm:py-6">
     <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
       <h2 className="text-[#e8c34e] font-extrabold text-base sm:text-lg md:text-xl lg:text-2xl tracking-wide flex flex-col sm:flex-row items-center justify-center text-center">
         <span>FOR FLYING INSECTS TREATMENT CALL AT :</span>
