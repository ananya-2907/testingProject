        ...
        <div className="relative z-10 flex flex-col lg:flex-row w-full">
          ...
          <div className="lg:w-2/3 lg:pr-8">
            ...
            <section className="mb-6">
              ...
              <ul className="list-disc ml-6 mt-3  text-gray-700 space-y-1 text-sm sm:text-base">
            ...
            <section className="mb-6">
              ...
              <ol className="list-decimal ml-6 mt-3 text-gray-700 space-y-1 text-sm sm:text-base">
          ...
          <div className="lg:w-1/3 mt-6 lg:mt-0 relative top-0 lg:top-4 h-fit bg-gray-50 p-6 rounded shadow-[0_4px_20px_rgba(34,197,94,0.4)] border">
