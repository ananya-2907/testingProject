  ...
  return (
    <nav className="bg-white p-2 shadow-md z-50 fixed top-0 left-0 w-full">
      <div className="container mx-auto flex justify-between items-center">
        ...
        {/* Nav Links */}
        <ul className={`flex-col lg:flex lg:flex-row lg:space-x-6 items-center relative absolute lg:static bg-white w-full lg:w-auto left-0 top-full lg:top-auto transition-all duration-300 ${isMobileMenuOpen ? "flex" : "hidden"} lg:flex`}>
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden px-4 pb-4">
          <Link
            to="/Allservices"
            className="bg-[#229c4f] text-white px-6 py-2 rounded-md hover:bg-green-800 transition font-semibold w-full block text-center"
          >
            Sign In
          </Link>
        </div>
